insert into car_table (model, carclass, price, text, seats) values
    ...
    ('Volkswagen Passat', 'ESTATE', 47.12, 'файна машина', 4),
    ('Fiat 500', 'MINI', 18.04, 'дуже маленька бібіка', 2),
    ('Ford Fiesta', 'ECONOMY', 43.39, 'шустра та потужна', 4),
    ('Kia Ceed SW', 'ESTATE', 61.23, 'комфортна та безпечна', 4),
    ('BMW X5', 'SUV', 125.91, 'розкішна та недешева', 4),
    ('Lamborghini Diablo', 'PREMIUM', 399.23, 'мегакрута та супершвидка', 2),
    ('Nissan Qashqai', 'SUV', 143.28, 'потужний та комфортний японець', 4);
    ('Jaguar XF', 'PREMIUM', 426.30, 'поважний британський лорд', 4);
...
insert into order_table (car_id, user_id, date_begin, date_end, passport_data, driver_needed, total, orderstatus) values
    (1, 1, '2022-02-22', '2022-02-23', 'AB123456', 'true', 10.222, 'NEW_ORDER'),
    (2, 2, '2022-02-28', '2022-03-01', 'AB456789', 'false', 0, 'NEW_ORDER'),
    (3, 3, '2022-03-12', '2022-03-14', 'BF545174', 'false', 0, 'NEW_ORDER'),
    (6, 3, '2022-03-12', '2022-03-14', 'AF543372', 'true', 0, 'NEW_ORDER'),
    (8, 1, '2022-03-12', '2022-03-14', 'FF345173', 'true', 0, 'NEW_ORDER');
